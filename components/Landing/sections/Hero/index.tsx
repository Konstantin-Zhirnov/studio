            ...
            <div className={styles.container}>
                <div className={styles.grid}>
                    <div>
                        ...
                        >
                            Websites & Web Apps for{" "}
                            <span className={styles.grad}>Small Businesses</span> on Vancouver Island
                        </motion.h1>
                        ...
                        >
                            Fast, mobile‑first websites that help you get more calls, bookings, and leads.
                            Clean design, local SEO, and reliable support.
                        </motion.p>
                        ...
                        >
                            <a className={styles.primary} href="#contact">Get a Free Quote</a>
                            <a className={styles.secondary} href="#work">See Our Work</a>
                        </motion.div>
                        ...
                        <motion.p
                            ...
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ duration: 0.65, ease, delay: 0.30 }}
                        >
                    ...
                    >
                        ...
                        <div className={styles.cardBottom}>
                            <a className={styles.miniCTA} href="#contact">Request a quote →</a>
